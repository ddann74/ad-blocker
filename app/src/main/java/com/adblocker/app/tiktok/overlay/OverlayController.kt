...
class OverlayController(
    ...
    fun show() {
        ...
        val view = LayoutInflater.from(service).inflate(R.layout.overlay_buttons_tiktok, null)
        ...
        try {
            ...
            overlayView = view
            diagnosticLog.log("TIKTOK/OVERLAY", "shown")
        } catch (e: Exception) {
            ...
            diagnosticLog.logError("TIKTOK/OVERLAY", "failed to show", e)
        }
    }
    ...
    fun hide() {
        ...
        try {
            ...
            diagnosticLog.log("TIKTOK/OVERLAY", "hidden")
        } catch (e: Exception) {
            // View may already be gone (e.g. service interrupted) - nothing to clean up.
            diagnosticLog.logError("TIKTOK/OVERLAY", "failed to hide (view may already be gone)", e)
        }
    }
}
