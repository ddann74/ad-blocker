...
import com.adblocker.app.spotify.ad.AdDetector
import com.adblocker.app.spotify.ad.DownloadOutcome
import com.adblocker.app.spotify.ad.SkipOutcome
import com.adblocker.app.spotify.overlay.OverlayController
...
class SpotifyAdSkipService : AccessibilityService() {
    ...
    override fun onServiceConnected() {
        ...
        diagnosticLog.log("SPOTIFY/SERVICE", "onServiceConnected")
    }
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent?) {
        ...
        if (!evaluation.isAdPlaying) {
            if (hasAttemptedCurrentAd) {
                diagnosticLog.log("SPOTIFY/AD", "ad no longer detected - ready for the next one")
            }
        ...
        diagnosticLog.log("SPOTIFY/AD", "ad detected - matched=\"${evaluation.matchedKeyword}\" - texts=$texts")
        ...
        diagnosticLog.log("SPOTIFY/SKIP", "outcome=$outcome, keywords=${settingsRepository.skipControlKeywords}")
    ...
    override fun onInterrupt() {
        diagnosticLog.log("SPOTIFY/SERVICE", "onInterrupt")
        mainHandler.removeCallbacks(hideOverlayRunnable)
    ...
    override fun onUnbind(intent: Intent?): Boolean {
        diagnosticLog.log("SPOTIFY/SERVICE", "onUnbind")
        mainHandler.removeCallbacks(hideOverlayRunnable)
        overlayController.hide()
    ...
    private fun handleOverlayDownloadTapped() {
        ...
        if (root == null) {
            ...
            diagnosticLog.log("SPOTIFY/OVERLAY", "Download tapped, rootInActiveWindow was null")
            return
        }
        ...
        diagnosticLog.log("SPOTIFY/DOWNLOAD", "outcome=$outcome, keywords=${settingsRepository.downloadControlKeywords}")
